...
<div class="box" style="padding: 3rem; margin-top: 1rem; margin-right: 1rem; max-width: 800px">
  <h1 class="title">AutoRepl Settings</h1>
  <a style="text-decoration: underline" href="https://app.autorepl.com/typebots" target="_blank">First, you need to create a AutoRepl Bot with our builder. It's free.</a>
  <form method="post" action="options.php" style="margin-top: 1rem">
    <?php
    settings_fields('autorepl');
    do_settings_sections('autorepl');
    ?>
      <div style="display: flex; flex-direction: column;">
        ...
        <div id="easy-block" style="display: <?php if (
          ...
          <div class="field">
            ...
            <div class="control">
              <input class="input" type="url" placeholder="Found in 'Share' page of your bot" name="url" value="<?php echo esc_attr(
                get_option('url')
              ); ?>">
            </div>
          </div>
          ...
          <div style="margin-top: 2rem; display:none" id="popup-params">
            ...
            <div class="field">
              <label class="label">Pages to include separated by a comma (optional)</label>
              <div class="control" style="margin-bottom: 1rem;">
          ...
          <div class="notification is-link" style="margin-bottom: 1rem;">
            ...
            <pre>[autorepl width="100%" height="500px" background-color="#F7F8FF" url="https://my.autorepl.com"]</pre>
          </div>
        <?php endif; ?>
        </div>
        ...
        <div id="code-block" style="display: <?php if (
          ...
          <label>Paste the code from "HTML & Js" in AutoRepl in the Share tab:</label>
